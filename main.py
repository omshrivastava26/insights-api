...
INSIGHTS: List[Insight] = [
    ...
    Insight(
        description="Actual Volume 84.4% lower  in Jan FY23",
        pov="Sales US-Working-USD-Forecast.-Ultra Notebook 15 in-US Market-TTM",
        insightType="Anomaly",
        id="55",
        priority="High",
    ),
    Insight(
        description="Actual Volume 83.8% lower  in Jan FY23",
        pov="Sales US-Working-USD-Forecast.-Sentinal Custom Notebook-US Market-TTM",
        insightType="Anomaly",
        id="41",
        priority="High",
    ),
    Insight(
        description="Actual Volume 82.9% lower  in Jan FY23",
        pov="Sales US-Working-USD-Forecast.-Keyboard-US Market-TTM",
        insightType="Anomaly",
        id="73",
        priority="High",
    ),
